...
cardissue: cardissue.c DESFireAES/desfireaes.o AXL/axl.o afile.o
	cc -g -Wall -Wextra -O -o cardissue cardissue.c -I. -IDESFireAES DESFireAES/desfireaes.o -IAXL AXL/axl.o -lcrypto -lpopt -pthread -lcurl -lmosquitto afile.o
...
afile.o: afile.c afile.h
	cc -g -Wall -Wextra -O -c -o afile.o afile.c -I. -IAXL -IDESFireAES -DLIB -pthread
