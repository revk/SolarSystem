...
alarmpanel: alarmpanel.c galaxybus.o galaxybus.h ../AXL/axl.o ../Dataformat/dataformat.o ../websocket/websocket.o trace.h
	cc -Wall -Wextra -O -o alarmpanel alarmpanel.c galaxybus.o -I. -I../AXL -I../Dataformat -I../websocket ../AXL/axl.o ../Dataformat/dataformat.o ../websocket/websocket.o -lcurl -lexpat -pthread -lpopt -DLIBWS ${LIBEMAIL} -g -lcrypto -lssl
