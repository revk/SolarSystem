...
translate([42.600000,17.200000,0.800000])rotate([0,0,180.000000])m18(pushed,hulled); // RevK:D_1206 D_1206_3216Metric (back)
translate([22.500000,13.100000,0.800000])rotate([-0.000000,-0.000000,-90.000000])m20(pushed,hulled); // RevK:SOT-23-Thin-6-Reg SOT-23-6 (back)
translate([48.500000,15.200000,0.800000])rotate([0,0,180.000000])m8(pushed,hulled); // RevK:R_0603 R_0603_1608Metric (back)
translate([12.000000,6.750000,0.800000])rotate([0,0,90.000000])m21(pushed,hulled); // RevK:ESP32-PICO-MINI-02 ESP32-PICO-MINI-02 (back)
translate([17.500000,17.000000,0.800000])rotate([0,0,-90.000000])m8(pushed,hulled); // RevK:R_0603 R_0603_1608Metric (back)
translate([26.400000,13.100000,0.800000])rotate([-0.000000,-0.000000,-90.000000])m23(pushed,hulled); // RevK:L_4x4_ TYA4020 (back)
translate([27.900000,1.800000,0.800000])rotate([0,0,90.000000])m13(pushed,hulled); // RevK:C_0805 C_0805_2012Metric (back)
translate([24.780000,9.930000,0.800000])m18(pushed,hulled); // RevK:D_1206 D_1206_3216Metric (back)
translate([20.400000,5.100000,0.800000])rotate([0,0,90.000000])m29(pushed,hulled); // RevK:C_0603_ C_0603_1608Metric (back)
translate([24.770000,2.190000,0.800000])m18(pushed,hulled); // RevK:D_1206 D_1206_3216Metric (back)
translate([38.700000,7.800000,0.800000])rotate([0,0,180.000000])m29(pushed,hulled); // RevK:C_0603_ C_0603_1608Metric (back)
translate([21.650000,1.800000,0.800000])rotate([0,0,90.000000])m13(pushed,hulled); // RevK:C_0805 C_0805_2012Metric (back)
translate([23.500000,17.000000,0.800000])rotate([0,0,-90.000000])m29(pushed,hulled); // RevK:C_0603_ C_0603_1608Metric (back)
translate([27.900000,9.550000,0.800000])rotate([0,0,90.000000])m13(pushed,hulled); // RevK:C_0805 C_0805_2012Metric (back)
translate([18.300000,14.100000,0.800000])rotate([0,0,90.000000])m31(pushed,hulled); // RevK:SOT-323_SC-70 SOT-323_SC-70 (back)
...
translate([26.400000,5.350000,0.800000])rotate([-0.000000,-0.000000,-90.000000])m23(pushed,hulled); // RevK:L_4x4_ TYA4020 (back)
...
translate([36.500000,16.250000,0.800000])rotate([0,0,90.000000])rotate([-0.000000,-0.000000,90.000000])m35(pushed,hulled); // RevK:Special-SOP-4-3.7x4.55 SO-4_4.4x3.6mm_P2.54mm (back)
translate([30.500000,16.750000,0.800000])rotate([0,0,180.000000])m36(pushed,hulled); // Package_TO_SOT_SMD:SOT-23 SOT-23 (back)
translate([33.750000,11.500000,0.800000])rotate([0,0,90.000000])m37(pushed,hulled); // RevK:QFN-20-1EP_4x4mm_P0.5mm_EP2.5x2.5mm QFN-20-1EP_4x4mm_P0.5mm_EP2.5x2.5mm (back)
translate([45.800000,15.200000,0.800000])rotate([0,0,180.000000])m8(pushed,hulled); // RevK:R_0603 R_0603_1608Metric (back)
translate([47.300000,17.200000,0.800000])m18(pushed,hulled); // RevK:D_1206 D_1206_3216Metric (back)
translate([19.500000,17.000000,0.800000])rotate([0,0,-90.000000])m8(pushed,hulled); // RevK:R_0603 R_0603_1608Metric (back)
translate([22.500000,5.350000,0.800000])rotate([-0.000000,-0.000000,-90.000000])m20(pushed,hulled); // RevK:SOT-23-Thin-6-Reg SOT-23-6 (back)
translate([11.500000,17.000000,0.800000])rotate([0,0,-90.000000])m8(pushed,hulled); // RevK:R_0603 R_0603_1608Metric (back)
translate([32.050000,7.800000,0.800000])rotate([0,0,180.000000])m29(pushed,hulled); // RevK:C_0603_ C_0603_1608Metric (back)
translate([7.500000,17.000000,0.800000])rotate([0,0,-90.000000])m8(pushed,hulled); // RevK:R_0603 R_0603_1608Metric (back)
translate([20.400000,12.850000,0.800000])rotate([0,0,90.000000])m29(pushed,hulled); // RevK:C_0603_ C_0603_1608Metric (back)
...
translate([15.000000,25.000000,0.000000])rotate([0,0,90.000000])rotate([180,0,0])m29(pushed,hulled); // RevK:C_0603_ C_0603_1608Metric
translate([11.000000,25.000000,0.000000])rotate([0,0,90.000000])rotate([180,0,0])m29(pushed,hulled); // RevK:C_0603_ C_0603_1608Metric
translate([7.000000,25.000000,0.000000])rotate([0,0,90.000000])rotate([180,0,0])m29(pushed,hulled); // RevK:C_0603_ C_0603_1608Metric
translate([18.000000,22.500000,0.000000])rotate([180,0,0])m38(pushed,hulled); // Package_TO_SOT_SMD:SOT-363_SC-70-6 SOT-363_SC-70-6
translate([6.000000,22.500000,0.000000])rotate([180,0,0])m38(pushed,hulled); // Package_TO_SOT_SMD:SOT-363_SC-70-6 SOT-363_SC-70-6
translate([17.000000,24.975000,0.000000])rotate([0,0,-90.000000])rotate([180,0,0])m29(pushed,hulled); // RevK:C_0603_ C_0603_1608Metric
translate([10.000000,22.500000,0.000000])rotate([180,0,0])m38(pushed,hulled); // Package_TO_SOT_SMD:SOT-363_SC-70-6 SOT-363_SC-70-6
translate([5.000000,25.000000,0.000000])rotate([0,0,90.000000])rotate([180,0,0])m29(pushed,hulled); // RevK:C_0603_ C_0603_1608Metric
translate([9.000000,25.000000,0.000000])rotate([0,0,90.000000])rotate([180,0,0])m29(pushed,hulled); // RevK:C_0603_ C_0603_1608Metric
translate([14.000000,22.500000,0.000000])rotate([180,0,0])m38(pushed,hulled); // Package_TO_SOT_SMD:SOT-363_SC-70-6 SOT-363_SC-70-6
translate([13.000000,25.000000,0.000000])rotate([0,0,90.000000])rotate([180,0,0])m29(pushed,hulled); // RevK:C_0603_ C_0603_1608Metric
}
