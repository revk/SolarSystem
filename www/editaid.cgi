...
<td title="Key rollover"><tt><output name=ver1date type="%F"> <b><output name=ver1></b></tt><input type=checkbox name="ROLLOVER$aid" id="ROLLOVER$aid"><label for="ROLLOVER$aid">
<if ver2><br><tt><output name=ver2date type="%F"> <output name=ver2></tt></if>
<if ver3><br><tt><output name=ver3date type="%F"> <output name=ver3></tt></if>
</label></td>
<td>
