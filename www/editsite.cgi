...
if($?sitename) then
	...
	sqlwrite -qon "$DB" site sitename wifissid wifipass iothost nomesh smsuser smspass armcancel alarmdelay alarmhold ioteventarm smsarm smsarmfail smsdisarm smsalarm smspanic engineer smsnumber smsfrom
